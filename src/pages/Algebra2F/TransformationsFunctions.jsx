...
const TransformationsFunctions = () => (
    ...
    <div className="bg-primary w-full overflow-hidden">
        ...
        <File title='Parent Functions 2' img={ParentFunctions2} link='https://drive.google.com/file/d/15wGGUBpyi7A6VZbjq17FcH82lQfs5FWD/view?usp=sharing' target='_blank' body = 'Download PDF' />
        <File title='Transformations Worksheet 3' img={TransformationsWorksheet3} link='https://drive.google.com/file/d/104d6g-TOsSCVob3-HbdDBxcKQrD9x8Kd/view?usp=sharing' target='_blank' body = 'Download PDF' />
        <File title='Transformations Worksheet 2' img={TransformationWorksheet2} link='https://drive.google.com/file/d/1xX-vS8i-eJOMzv3oR1g-OuUCAAvN2RwO/view?usp=sharing' target='_blank' body = 'Download PDF' />
        <File title='Transformations Worksheet' img={TransformingFunctionsWorksheet} link='https://drive.google.com/file/d/1Jq1PhyBDT6r7RT1_pPyM4xTKZ0RWp-au/view?usp=sharing' target='_blank' body = 'Download PDF' />
